...
@section('content')
    ...
    <div class="container-fluid">
        <h1>Agregar Detalle Recurso</h1>
        <form method="POST" action="{{ route('detallerecursos.store') }}" style="width: 35rem;" class="mx-auto">
            ...
            <div class="col-md-10">
                ...
                <input type="number" class="form-control" id="tipo_recurso" name="tipo_recurso" value="{{ old('tipo_recurso') }}">
                <div class="form-text text-danger">{{ $errors->first('tipo_recurso') }}</div>
            </div>
            <div class="col-md-10">
                <label for="recurso_id">Recurso Id</label>
                <input type="number" class="form-control" id="recurso_id" name="recurso_id" value="{{ old('recurso_id') }}">
