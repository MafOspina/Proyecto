  ...
  <div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0 text-primary ">Agregar empresa</h4>
      </div>
      <div class="card-body">
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" id="nomEmp" name="nomEmp" value="{{ old('nomEmp') }}"/>
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="number" class="form-control" id="nitEmp" name="nitEmp" value="{{ old('nitEmp') }}"/>
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="number" class="form-control" id="telEmp" name="telEmp" value="{{ old('telEmp') }}"/>
          </div>
        ...
        <div class="mb-3">
          ...
          <div class="input-group input-group-merge">
            ...
            <input type="text" class="form-control" id="dirreEmp" name="dirreEmp" value="{{ old('dirreEmp') }}"/>
          </div>
        ...
        <div class="mb-3">
          ...
          <select class="form-select" name="estEmp" id="bs-validation-country">
              <option value="1" {{ old('estEmp') == '1' ? 'selected' : '' }}>Habilitado</option>
              <option value="0" {{ old('estEmp') == '0' ? 'selected' : '' }}>Inhabilitado</option>
            </select>
