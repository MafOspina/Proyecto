...
<body>
    <div class="container-fluid">
        <h1>Obervaciones</h1>
        <h1>Editar</h1>
        <form method="POST" action="{{ route('observaciones.update',  $observacione ->id ) }}" :observacione="$observacione" style="width: 35rem;" class="mx-auto">
            ...
            <div class="col-md-10">
                ...
                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="descripcion" value="{{ old('descripcion') }}">{{$observacione->descripcion }}</textarea>
