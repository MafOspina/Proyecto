  ...
  <div class="col-xl">
    <div class="card mb-4">
      <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0 text-primary ">Agregar observación</h4>
      </div>
      <div class="card-body">
        ...
        <form method="POST" action="{{ route('observaciones.store') }}" >
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-merge">
                ...
                <textarea  class="form-control" name="descripcion" rows="3"> {{ Request::old('descripcion') }}</textarea>
              </div>
            ...
            <select class="form-select" name="tipoObservacion" id="tipoObservacion" id="bs-validation-country">
                ...
                <option value="logistica" {{ old('tipoObservacion') == 'logistica' ? 'selected' : '' }}>Logística</option>
                <option value="voluntarios" {{ old('tipoObservacion') == 'voluntarios' ? 'selected' : '' }}>Voluntarios</option>
                <option value="recursos" {{ old('tipoObservacion') == 'recursos' ? 'selected' : '' }}>Recursos</option>
